...
st.title("Upload your resumes and categorize them into different categories.")
st.subheader("I hope you have a great day ahead!")

uploaded_files = st.file_uploader("Please Choose PDF files", type="pdf", accept_multiple_files=True)
